...
export default function Dashboard(props) {
  ...
  let leaderBoardInnerContent;
  let submissionHeader;
  let submissionInnerContent;
    ...
    leaderBoardInnerContent = props.leaderboard.map((row) =>
    <div>
    <Grid container>
      <Grid item xs={12} sm={8} md={4}>
    ...
    submissionInnerContent = props.submissionDetails.map((row) =>
    <div>
    <Grid container>
      <Grid item xs={12} sm={8} md={3}>
        <Typography component="h1">
    ...
    <div className={classes.root}>
      ...
      <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          <IconButton color="inherit" onClick={props.onRefresh}>
              <RefreshIcon />
      ...
      >
        ...
        <Divider />
        <List><MainListItems onLeaderboardClick={handleClickLeaderboard}  onSubmissionsClick={handleClickSubmission}/></List>
      </Drawer>
